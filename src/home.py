...
st.markdown("<h1 style='text-align: center; font-size: 3 rem; margin-top: 4rem;'>Human or Machine?</h1>", unsafe_allow_html=True)

st.markdown("""
<div style='text-align: center; max-width: 1000px; margin: 0 auto; padding: 0 1 rem;'>
